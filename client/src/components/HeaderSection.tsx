...
export const HeaderSection = () => {
  ...
  return (
    <>
      <header className="h-14 sm:h-16 lg:h-20 flex items-center justify-between px-4 sm:px-12 lg:px-24 border-b border-white/5 bg-[#050505]/80 backdrop-blur-md z-50 fixed top-0 left-0 right-0">

    ...
    const handleToggleMute = () => {
      if (videoRef.current) {
        ...
        window.dispatchEvent(
          new CustomEvent("muteStateChange", { detail: muted }),
        );
      }
    };
    ...
    <section className="relative min-h-[100svh] flex flex-col justify-center overflow-hidden border-b border-white/5 z-10 px-4 sm:px-12 lg:px-24 pt-20 sm:pt-24 lg:pt-28 pb-8">
      ...
      <div className="max-w-5xl relative z-10 flex flex-col gap-4 sm:gap-6 pl-2 sm:pl-4">
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-6xl md:text-7xl lg:text-[6rem] font-black italic tracking-tighter leading-[0.95] uppercase text-white"
        >
        ...
        <motion.h2
          ...
          className="text-xl sm:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight uppercase"
        >
      ...
      "
        ...
        >
          ...
          technology <br /> conference bringing together developers, cloud
          enthusiasts, innovators, and industry <br /> professionals for a full
